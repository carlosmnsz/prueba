...
#line 140 "Sintactico.y"
                    {fputs("}\n", principal); insertaEtiqSalida(); fputs("{}\n", principal); yyval.lexema=yyvsp[-7].lexema;}
...
#line 180 "Sintactico.y"
                                     {TS_OpBinArroba(yyvsp[-2], yyvsp[-1], yyvsp[0], &yyval); generaArroba(&yyval, yyvsp[-2], yyvsp[0]);}
#line 1886 "Sintactico.tab.c"
    break;

  case 75:
#line 181 "Sintactico.y"
                                                      { yyval.numDim=1; TS_OpTerciario(yyvsp[-4], yyvsp[-2], yyvsp[0], &yyval); generaArrobaMasMas(yyval, yyvsp[-4], yyvsp[-2], yyvsp[0]);}
